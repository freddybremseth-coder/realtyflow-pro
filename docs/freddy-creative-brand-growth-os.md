...
| --- | --- | --- | --- |
| `freddyb` — Freddy Bremseth | Public personal umbrella: tell Freddy's own story as an artist, music creator, author and entrepreneur. Selected verified projects only. | Existing Freddy Bremseth Facebook **Page** (`1324025764122967`); website. Personal FB profile excluded. | Controlled autopilot allowed for the exact public Page only. Personal/private Facebook is never a destination. Do **not** copy every child-brand post. |
...
5. Freddy umbrella Facebook: controlled autopilot may publish rewritten, first-person umbrella posts only to the exact verified public Facebook Page ID `1324025764122967`. The private/personal Facebook profile is never a destination. Use verified ART/MUSIC/BOOKS/project sources, respect creative-source cooldowns, and do not mirror child-brand captions or full daily Art Reels onto the umbrella automatically.
...
- Current `freddypublishing` Facebook channel shares the professional umbrella Page. Keep book-brand publishing separate; selected book stories may appear through the `freddyb` umbrella autopilot only as rewritten first-person editorial posts.
