...
Property recommendation sends and viewing bookings are `HUMAN_REQUIRED` under V1. Send-preflight can return READY, but READY remains a validation result rather than permission to send.
