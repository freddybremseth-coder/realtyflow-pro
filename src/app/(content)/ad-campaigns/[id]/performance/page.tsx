...
type CreativeRow = {
  ...
  image_url:string|null; thumbnail_url:string|null; provider:string|null; model:string|null; generation_type:string; parent_creative_id:string|null; evidence:Evidence; metrics:Metrics;
...
type Payload = {
  ...
  generatedAt:string; metrics:Metrics; creativeCount:number; attributedCreativeTouchpoints:number; unattributedCampaignTouchpoints:number; note:string; creatives:CreativeRow[];
};
