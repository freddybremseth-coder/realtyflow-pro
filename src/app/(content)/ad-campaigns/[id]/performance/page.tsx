...
type Payload = {
  ...
  generatedAt:string; metrics:Metrics; economics:Economics; creativeCount:number; attributedCreativeTouchpoints:number; unattributedCampaignTouchpoints:number; paidMediaRows:number; note:string; creatives:CreativeRow[];
};
