...
const LINKS = [
  { href: "/nexus-os/morning-brief", label: "Morning Brief" },
  ...
  { href: "/nexus-os/email-link-health", label: "Email Link Health" },
      ...
      <div className="mx-auto max-w-[1600px] px-4 pb-4 pt-5 sm:px-6">
        <div className="flex flex-wrap items-end justify-between gap-4">
          ...
          <div className="flex gap-2">
            <Link href="/nexus-os/morning-brief" className="rounded-xl border border-cyan-300/60 bg-cyan-300/10 px-4 py-2 text-xs font-black text-cyan-100 transition hover:bg-cyan-300/20">Morning Brief →</Link>
