...
export async function GET(request: NextRequest) {
  ...
  // Candidate selection is intentionally performed inside Postgres. The RPC marks
  // rows as processing in the same transaction and uses FOR UPDATE SKIP LOCKED,
  // preventing stale reads or overlapping cron instances from processing a row twice.
