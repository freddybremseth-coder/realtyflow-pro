...
export async function GET(request: NextRequest) {
  ...
  // The Re-Master OAuth connection is shared by every playlist operation in
  // this run. Verify it once so an account-wide revoked token does not trigger
  // the same Google refresh attempt for every completed mix.
  try {
