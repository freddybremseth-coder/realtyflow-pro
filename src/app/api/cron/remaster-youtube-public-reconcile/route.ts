...
const PATH = "/api/cron/remaster-youtube-public-reconcile";
...
export async function GET(request: NextRequest) {
  ...
  if (logError) console.error("[remaster-youtube-public-reconcile] automation log failed", logError.message);
