      ...
      <div className="flex flex-wrap items-start justify-between gap-4">
        <div>
          ...
          <p className="mt-2 max-w-3xl text-sm leading-6 text-slate-700">
            ...
            SEO-justeringer kan utføres innenfor den godkjente pilotrammen og måles i etterkant.
            Større endringer og sensitive opplysninger krever særskilt godkjenning.
          </p>
        ...
        <>
          ...
          {data.changeEvaluations?.length > 0 && (
            <section aria-label="Automatisk måling av SEO-endringer"
              ...
              <p className="mt-1 text-sm">Disse avgrensede endringene er dokumentert og krever ikke en ny godkjenningsoppgave. Sam sammenligner samme Google-søk og side etter en hel 30-dagersperiode uten overlapp med tiden før endringen.</p>
