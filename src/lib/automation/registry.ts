...
const REGISTRY_ROWS: AutomationRegistryRow[] = [
  ...
  ["/api/cron/corporate-homes-discovery", "Corporate Homes discovery", "growth", "Zen Eco Homes", "live", "Nye kvalifiserbare B2B-prospekter", "Fyller Corporate Homes-køen med offentlig virksomhetsdata fra Brønnøysundregistrene til målet på 250.", "Inntil 25 nye A/B-fit selskapsprospekter per dag til målet på 250 er nådd; ingen personberikelse eller utsendelse.", "cron-safe", ["corporate_homes_discovery"]],
  ["/api/cron/corporate-homes-content-drafts", "Corporate Homes content drafts", "growth", "Zen Eco Homes", "draft-first", "Jevn B2B-organisk synlighet", "Oppretter tre norske Corporate Homes-utkast per uke fra det godkjente artikkelbiblioteket.", "Tre Content Hub-utkast for LinkedIn og Facebook; ingen ekstern publisering.", "cron-safe", ["corporate_homes_content_drafts"]],
  ["/api/cron/corporate-homes-bootstrap", "Corporate Homes first batch", "growth", "Zen Eco Homes", "live", "Første kvalifiserte selskapsbatch", "Kjører bare mens Corporate Homes-køen er tom og blir deretter no-op.", "Inntil 25 A/B-fit selskapsprospekter fra offentlig Brønnøysund-data; ingen personberikelse eller utsendelse.", "cron-safe", ["corporate_homes_bootstrap"]],
  ...
  ["/api/cron/seo-autopilot", "Sam SEO daglig autopilot", "growth", "Sam SEO", "live", "Utførte kontroller og verifiserte metadataendringer", "Kontrollerer åtte offentlige nettsteder og Care daglig; publiserer bare innenfor Zen Eco Homes-metadatapiloten.", "Lagrede Google-data, tekniske kontroller, avvik og bekreftet publisering eller blokkering.", "cron-safe", ["seo_autopilot_pilot_cycle"]],
  ["/api/cron/seo-growth-review", "Sam SEO Portfolio Growth Review", "growth", "Analytics", "draft-first", "Verifiserte søke- og AI-henvisninger per merke", "Leser RealtyFlows målte søke-/AI-henvisninger og vurderer endringer uten å dikte søkeord eller rangering.", "Datakvalitet, merkeoversikt og forbedringsforslag i automation_logs; ingen publisering uten godkjenning.", "cron-safe", ["seo_portfolio_growth_review"]],
