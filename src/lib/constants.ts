...
export const SIDEBAR_NAV = {
  overview: [
    ...
    { label: "Inntektsoversikt", href: "/revenue-command", icon: "Gauge" },
    ...
    { label: "Fakturering", href: "/billing", icon: "FileText" },
  ...
  operations: [
    ...
    { label: "Gjennomføring", href: "/execution", icon: "CalendarCheck2" },
    { label: "Closing (kontrakt til nøkkel)", href: "/closing", icon: "Target" },
    { label: "Salgsdokumenter", href: "/closing-pack", icon: "FolderLock" },
  ...
  care: [
    { label: "Care oversikt", href: "/care", icon: "KeyRound" },
    { label: "Care kunder & eiendommer", href: "/care/customers", icon: "Users" },
    { label: "Care rapporter & bilder", href: "/care/reports", icon: "Image" },
    { label: "Care faktura & tillegg", href: "/care/invoices", icon: "FileSpreadsheet" },
    { label: "Care nøkler & kalender", href: "/care/keys", icon: "CalendarCheck2" },
    { label: "Serviceinntekt", href: "/service-revenue", icon: "KeyRound" },
  ],
  properties: [
  ...
  content: [
    ...
    { label: "Posts & publisering", href: "/posts", icon: "Send" },
  ...
  growth: [
    ...
    { label: "Forfatterstudio", href: "/publishing/forfatterstudio", icon: "Feather" },
    { label: "Book Growth OS", href: "/book-growth", icon: "BookOpen" },
    { label: "Growth Hub", href: "/growth-hub", icon: "Rocket" },
    { label: "Instagram & Social Automation", href: "/social-automation", icon: "Megaphone" },
    { label: "Marketing Readiness", href: "/marketing-readiness", icon: "ShieldCheck" },
    { label: "Ad Campaigns", href: "/ad-campaigns", icon: "Target" },
    { label: "Market Intelligence", href: "/reports", icon: "TrendingUp" },
    { label: "Analytics", href: "/analytics", icon: "BarChart3" },
  ],
  automation: [
    { label: "RealtyFlow OS", href: "/os", icon: "PanelsTopLeft" },
    { label: "Nexus OS", href: "/nexus", icon: "Boxes" },
  ...
  admin: [
    ...
    { label: "Doña Anna", href: "/dona-anna", icon: "Store" },
