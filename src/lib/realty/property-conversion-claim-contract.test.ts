...
test("conversion cron uses the atomic claim RPC rather than a nullable PostgREST select", () => {
...
test("generation failures are persisted instead of creating an immediate retry loop", () => {
