...
const BRAND_DESTINATIONS: Record<string, WebsiteCmsDestination[]> = {
  ...
  zeneco: [
    { id: "blogg", label: "Blogg", path: "/blog", contentType: "post" },
    { id: "boligartikler", label: "Boligartikler", path: "/articles", contentType: "article" },
    { id: "omradeguider", label: "Områdeguider", path: "/area-guides", contentType: "guide" },
    { id: "kundeguider", label: "Kjøperguider", path: "/buyer-guides", contentType: "guide" },
  ],
  pinosoecolife: [
    { id: "blogg", label: "Blogg", path: "/blog", contentType: "post" },
    { id: "livsstil", label: "Livsstil", path: "/lifestyle", contentType: "article" },
    { id: "boliger", label: "Boligartikler", path: "/properties", contentType: "article" },
    { id: "guider", label: "Guider", path: "/guides", contentType: "guide" },
  ],
  soleada: [
    { id: "magasin", label: "Magasin", path: "/magasin", contentType: "magazine" },
    { id: "artikler", label: "Artikler", path: "/artikler", contentType: "article" },
  ...
  chatgenius: [
    { id: "blogg", label: "Blogg", path: "/blog", contentType: "post" },
    { id: "case", label: "Case", path: "/case-studies", contentType: "article" },
    { id: "guider", label: "Guider", path: "/guides", contentType: "guide" },
    { id: "ressurser", label: "Ressurser", path: "/resources", contentType: "guide" },
  ],
  freddyb: [
    { id: "artikler", label: "Artikler", path: "/artikler", contentType: "article" },
    { id: "blogg", label: "Blogg", path: "/blogg", contentType: "post" },
